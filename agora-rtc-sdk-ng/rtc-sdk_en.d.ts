...
declare class AgoraRTCError extends Error {
    readonly code: AgoraRTCErrorCode | AgoraRTCErrorCode_2;
    readonly message: string;
    readonly data?: any;
    readonly name: string;
    constructor(code: AgoraRTCErrorCode | AgoraRTCErrorCode_2, message?: string, data?: any);
    toString(): string;
 ...
 * @ignore
 */
declare enum AgoraRTCErrorCode_2 {
    UNEXPECTED_ERROR = "UNEXPECTED_ERROR",
    UNEXPECTED_RESPONSE = "UNEXPECTED_RESPONSE",
    TIMEOUT = "TIMEOUT",
    INVALID_PARAMS = "INVALID_PARAMS",
